...
class NourRepository(private val dao: NourDao) {
    ...
    suspend fun awardManualPoints(points: Int, focus: Int = 10) {
        dao.addPointsAndFocus(addPoints = points, addFocus = focus)
    }
